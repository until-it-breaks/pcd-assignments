...
import pcd.poool.model.collision.ThreadedLockFreeCollisionResolver;
...
public class TestThreadedLockFreeCollisionResolver {
    public static void main(String[] args) throws InterruptedException {
        ...
        CollisionResolver resolver = new ThreadedLockFreeCollisionResolver(2);
